...
```{r}
get_residuals <- function(data, outcome, covariates, Z, tau, model) {
...
```{r}
myest_fun <- function(tau, data, outcome, covariates, Z, alpha = 0.05, model = "lm") {
  adj_resid <- get_residuals(data, outcome, covariates, Z, tau, model)
